...
PYBIND11_MODULE(sampling, m)
{
    ...
    m.def("sample_negative_score", &sample_negative_score,"sampling negatives scores for all",
    "user_num"_a, "item_num"_a, "train_num"_a, "allPos"_a,"allPosScore"_a, "neg_num"_a);
